...
const canvasMouseUp = function (event) {
  ...
  const originX = ((offsetWidth - shorterSide) / 2) + this.layout.outerMargin;
  const originY = ((offsetHeight - shorterSide) / 2) + this.layout.outerMargin;
